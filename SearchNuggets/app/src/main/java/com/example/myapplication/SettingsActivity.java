...
public class SettingsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(sharedPref.getInt("Radius", 0) != 0){
            _distanceBar.setProgress(sharedPref.getInt("Radius", 0));
            _meter = (TextView)findViewById(R.id.meter);
            _meter.setText(Integer.toString(sharedPref.getInt("Radius", 0)) + " meters");

        }
        _distanceBar.setMax(5000);
        ...
        _distanceBar.setOnSeekBarChangeListener(new SeekBar.OnSeekBarChangeListener() {
            ...
            public void onProgressChanged(SeekBar seekBar, int progress, boolean fromUser) {
                ...
                meter.setText(Integer.toString(progressChangedValue) + " meters");
            }
